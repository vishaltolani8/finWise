...
Future<Map<String, dynamic>> getDefaultPreferences() async {
  return {
    ...
    "backupLimit": 20,
    "backupSync": !finWiseMvpMode,
    "syncEveryChange": finWiseMvpMode ? false : kIsWeb,
    ...
    "automaticallyPayUpcoming": !finWiseMvpMode,
    "automaticallyPayRepetitive": !finWiseMvpMode,
    "automaticallyPaySubscriptions": !finWiseMvpMode,
    ...
    "notifications": !finWiseMvpMode,
    "notificationHour": 20,
    "notificationMinute": 0,
    "notificationsUpcomingTransactions": !finWiseMvpMode,
