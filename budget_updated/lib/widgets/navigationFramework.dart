...
import 'package:budget/pages/aiInsightsPage.dart';
...
class PageNavigationFrameworkState extends State<PageNavigationFramework> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      ...
      bool isChangelogShown = finWiseMvpMode ? true : showChangelog(context);
      bool isRatingPopupShown = false;
      if (!finWiseMvpMode && isChangelogShown == false) {
