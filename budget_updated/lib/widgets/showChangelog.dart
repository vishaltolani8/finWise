...
String getChangelogString() {
  return """
    ...
    When tapping support, FinWise Pro options highlight
    ...
    < 3.8.0
    FinWise pro background now extends past scrollable area - support for (i) over-scroll
    ...
    < 3.7.5
    FinWise Pro banner in settings
