...
Future updateWidgetColorsAndText(BuildContext context) async {
  ...
  await Future.delayed(Duration(milliseconds: 500), () async {
    ...
    await HomeWidget.updateWidget(
      qualifiedAndroidName: 'com.budget.tracker_app.NetWorthWidgetProvider',
    );
    await HomeWidget.updateWidget(
      qualifiedAndroidName: 'com.budget.tracker_app.NetWorthPlusWidgetProvider',
    );
    await HomeWidget.updateWidget(
      qualifiedAndroidName: 'com.budget.tracker_app.PlusWidgetProvider',
    );
    await HomeWidget.updateWidget(
      qualifiedAndroidName: 'com.budget.tracker_app.TransferWidgetProvider',
    );
  });
