...
metrics from the Flutter app and returns personalized guidance using Gemini.
...
If `GEMINI_API_KEY` is not set, the service returns a deterministic fallback so
